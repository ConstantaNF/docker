...
Вывод: образ является эталонной сборкой для запуска контейнеров, которые, в свою очередь, являются модифицированной производной образа и конечным этапом для запуска сервиса.
